# KeenKit
### A multifunctional script that simplifies interaction with a router based on KeeneticOS
...
# Installation
1. Connect via `SSH` к [Entware](https://keen-prt.github.io/wiki/helpful/entware)
